...
async function searchButtonClickHandler() {
    try {
        ...
        alert(error.message);  // Substituído notie.alert por window.alert
    }
}
...
function removeFilmFromList(id) {
    if (confirm("Deseja remover o filme de sua lista?")) {  // Substituído notie.confirm por window.confirm
